...
export function LinkItem({ link, categories, categoryName }: Props) {
  ...
  return (
    <div className="group card-sm p-3.5 animate-slide-up">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          ...
          <button onClick={handleDelete} className="p-2 rounded-xl hover:bg-red-500/10 text-[var(--text-tertiary)] hover:text-red-500 transition">
            <TrashIcon size={14} />
          </button>
        </div>
      </div>
